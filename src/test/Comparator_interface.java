 ...
 * A comparator interface is used to order the objects of user-defined 
 * classes. A comparator object is capable of comparing two objects of 
 * the same class.
 */
...
public class Comparator_interface {
    public static void main(String[] args) {
        ...
        Collections.sort(studentList, new CustomerSortingComparator());
        ...
        for (Student customer : studentList) {
